...
class PoseSensorManager : public msf_core::MSF_SensorManagerROS<msf_updates::EKFState> {
 ...
 private:
  ...
  /// Minimum initialization height. If a abs(height) is smaller than this value, no initialization is performed.
  ...
  bool InitScale(sensor_fusion_comm::InitScale::Request &req, sensor_fusion_comm::InitScale::Response &res) {
  ...
  bool InitHeight(sensor_fusion_comm::InitHeight::Request &req, sensor_fusion_comm::InitHeight::Response &res) {
  ...
  virtual void SetStateCovariance(Eigen::Matrix<double, EKFState_T::nErrorStatesAtCompileTime, EKFState_T::nErrorStatesAtCompileTime>& P) const {
    UNUSED(P);
